...
IF (NOT SIFTGPU_DIR)
    ...
    FIND_PATH(SIFTGPU_INCLUDE_DIRS SiftGPU.h HINTS ${SIFTGPU_DIR}/src/SiftGPU /usr/local/include)
...
if (WIN32)
    ...
    FIND_LIBRARY(SIFTGPU_LIBRARIES siftgpu HINTS "${SIFTGPU_DIR}/bin" /usr/local/lib)
